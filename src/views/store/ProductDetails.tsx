...
const ProductDetails = ({ productId }: ProductDetailsProps) => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f8f9fa' }}>
        ...
        <Container maxWidth="xl">
          <Toolbar sx={{ justifyContent: 'space-between', py: 1.5 }}>
            ...
            >
              ...
              >
                <i className="ri-shopping-bag-3-fill" style={{ color: 'white', fontSize: 24 }} />
              </Box>
              <Typography
                variant="h6"
                sx={{
            ...
            <Stack direction="row" spacing={1} sx={{ display: { xs: 'none', md: 'flex' } }}>
              {['Home', 'Shop', 'Categories', 'Sale', 'Contact'].map(item => (
                <Button
                  key={item}
                  sx={{
                    color: 'text.primary',
              ...
              <TextField
                ...
                sx={{
                  ...
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&:hover fieldset': { borderColor: '#009BFF' },
                    '&.Mui-focused': {
                      '& fieldset': { borderColor: '#009BFF', borderWidth: 2 },
                      boxShadow: '0 0 0 3px rgba(0, 155, 255, 0.1)'
                    }
                  }
                }}
                InputProps={{
      ...
      {/* Footer - Same as StorePage (simplified version) */}
      <Box
        sx={{
      ...
      >
        <Container maxWidth="xl">
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            ...
            <Typography variant="body2" sx={{ opacity: 0.8, maxWidth: 600, mx: 'auto', fontSize: '0.85rem' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 4 }}>
            <Typography variant="body2" sx={{ opacity: 0.7, fontSize: '0.85rem' }}>
              © 2024 Khamatko. All rights reserved.
            </Typography>
            <Stack direction="row" spacing={2}>
              {['Privacy', 'Terms', 'Contact'].map(link => (
                <Typography key={link} variant="body2" sx={{ opacity: 0.7, cursor: 'pointer', fontSize: '0.85rem', '&:hover': { color: '#009BFF' } }}>
                  {link}
                </Typography>
              ))}
            </Stack>
