    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#f8f9fa' }}>
      ...
      <Box sx={{ bgcolor: 'white', borderBottom: '1px solid', borderColor: 'divider', py: 2 }}>
        <Container maxWidth="lg">
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            HOME / <Box component="span" sx={{ fontWeight: 600, color: 'text.primary' }}>OFFERS TERMS EXCHANGE & RETURN POLICY CONDITIONS</Box>
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Typography variant="h3" sx={{ fontWeight: 700, mb: 2, color: 'text.primary' }}>
          Offers Terms Exchange & Return Policy Conditions
        </Typography>
        ...
        <Stack spacing={4}>
          ...
          <Paper elevation={0} sx={{ p: 4, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              >
                <i className="ri-arrow-go-back-line" style={{ fontSize: 24, color: '#009BFF' }} />
              </Box>
              <Box>
                ...
                <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.8, mb: 2 }}>
                  You have <strong>14 days</strong> from the date of delivery to return any product. Products must be unused, unopened, and in
                  their original packaging with all tags attached.
                </Typography>
                <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.8 }}>
                  Please note that for hygiene reasons, opened beauty and personal care products cannot be returned unless they are defective.
                </Typography>
              </Box>
            </Box>
          </Paper>
