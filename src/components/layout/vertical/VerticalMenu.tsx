...
const VerticalMenu = ({ dictionary, scrollMenu }: Props) => {
  ...
  return (
    ...
    <MenuItem
      icon={<i className='ri-store-3-line' />}
      href={`/${locale}/apps/ecommerce/orders/requests`}
      exactMatch={false}
      activeUrl='/apps/ecommerce/orders/requests'
    >
      {dictionary['navigation'].orders}
    </MenuItem>
    <MenuItem
      icon={<i className='ri-truck-line' />}
      href={`/${locale}/apps/ecommerce/shipments`}
      exactMatch={false}
    ...
    <MenuItem
      ...
      href={`/${locale}/apps/ecommerce/transactions`}
      exactMatch={false}
      activeUrl='/apps/ecommerce/transactions'
    >
